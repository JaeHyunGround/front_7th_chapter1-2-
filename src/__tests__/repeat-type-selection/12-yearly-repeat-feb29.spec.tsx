...
describe('매년 반복 생성 - 윤년 2월 29일 특수 케이스', () => {
  it('2024-02(윤년)에는 2월 29일 이벤트가 표시된다', async () => {
    setupMockHandlerCreation([
      {
        ...
        location: '',
        category: '업무',
        repeat: { type: 'yearly', interval: 4, endDate: '2024-02-29' },
        notificationTime: 10,
      },
    ]);
    ...
    expect(
      (await within(view2024Feb).findAllByText('2월29일 테스트')).length
  ...
  it('2028-02(윤년)에는 2월 29일 이벤트가 표시된다', async () => {
    setupMockHandlerCreation([
      {
        ...
        location: '',
        category: '업무',
        repeat: { type: 'yearly', interval: 4, endDate: '2028-02-29' },
        notificationTime: 10,
      },
    ]);
    ...
    expect(
      (await within(view2028Feb).findAllByText('2월29일 테스트')).length
    ).toBeGreaterThanOrEqual(1);
  }, 20000);
});
